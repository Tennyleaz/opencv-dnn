...
# detected object names, confidences, and the result image
class DetectionResult:
    objects: list[tuple[str, int]] = []
    image: MatLike


def detect_objects(frame: MatLike) -> DetectionResult:
    # Load dnn model
    ...
    if len(indices) > 0:
        ...
        for i in indices:
            ...
            detection_result.objects.append((label, confidence))
    else:
        print(" - No object found.")

    detection_result.image = frame
